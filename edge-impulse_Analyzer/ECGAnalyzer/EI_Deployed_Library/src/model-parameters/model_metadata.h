...
#define EI_CLASSIFIER_PROJECT_ID                 19449
#define EI_CLASSIFIER_PROJECT_OWNER              "Manivannan"
#define EI_CLASSIFIER_PROJECT_NAME               "ECG Analyzer"
#define EI_CLASSIFIER_PROJECT_DEPLOY_VERSION     3
#define EI_CLASSIFIER_NN_INPUT_FRAME_SIZE        33
#define EI_CLASSIFIER_RAW_SAMPLE_COUNT           606
#define EI_CLASSIFIER_RAW_SAMPLES_PER_FRAME      3
#define EI_CLASSIFIER_DSP_INPUT_FRAME_SIZE       (EI_CLASSIFIER_RAW_SAMPLE_COUNT * EI_CLASSIFIER_RAW_SAMPLES_PER_FRAME)
#define EI_CLASSIFIER_INPUT_WIDTH                0
#define EI_CLASSIFIER_INPUT_HEIGHT               0
#define EI_CLASSIFIER_INTERVAL_MS                4.95049504950495
#define EI_CLASSIFIER_OUT_TENSOR_NAME            "y_pred/Softmax_1:0"
#define EI_CLASSIFIER_LABEL_COUNT                3
#define EI_CLASSIFIER_HAS_ANOMALY                0
#define EI_CLASSIFIER_FREQUENCY                  202
...
#define EI_CLASSIFIER_TFLITE_INPUT_SCALE         0.44246551394462585
...
const char* ei_classifier_inferencing_categories[] = { "Atrial Fibrillation", "First-Degree Heart Block", "Normal" };
